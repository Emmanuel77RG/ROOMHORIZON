...
public class ELIMINAREMPLEADO extends javax.swing.JFrame {
    ...
    private void agregarBotonEliminar() {
        ...
        jTable1.getColumn("Eliminar").setCellRenderer(new TableCellRenderer() {
            @Override
        ...
        jTable1.getColumn("Eliminar").setCellEditor(new DefaultCellEditor(new JCheckBox()) {
            @Override
            public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
                ...
                button.addActionListener(e -> {
                    ...
                    if (confirmar == JOptionPane.YES_OPTION) {
                        ((DefaultTableModel) jTable1.getModel()).removeRow(row); // Elimina la fila
                    }
                });
                return button;
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Filtrar empleados");
